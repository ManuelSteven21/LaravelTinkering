        ...
        <div class="container mx-auto bg-black bg-opacity-70 text-white p-8 rounded-lg shadow-lg max-w-4xl">
            ...
            <form action="{{ route('games.store') }}" method="POST" class="space-y-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="rating" id="rating" class="text-black form-input mt-2 block w-full rounded-md border border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 text-lg sm:text-base md:text-sm" required>
                </div>
